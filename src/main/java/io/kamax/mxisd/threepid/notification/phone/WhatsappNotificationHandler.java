...
public class WhatsappNotificationHandler extends GenericNotificationHandler<PhoneConnector, PhoneGenerator> {

    public static final String ID = "whatsapp";

    private PhoneWhatsappConfig cfg;

    public WhatsappNotificationHandler(PhoneWhatsappConfig cfg, List<PhoneGenerator> generators, List<PhoneConnector> connectors) {
        this.cfg = cfg;
